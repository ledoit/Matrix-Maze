 ...
 * @returns {string}
 */
export function update_game(state_json, input_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const ret = wasm.update_game(ptr0, len0, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string[]}
 */
export function render_frame(state_json, width, height) {
    const ptr0 = passStringToWasm0(state_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.render_frame(ptr0, len0, width, height);
 ...
 * @returns {string}
 */
export function next_level(state_json) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(state_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.next_level(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('matrix_maze_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
